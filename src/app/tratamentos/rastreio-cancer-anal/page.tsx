          ...
          <div className="mx-auto max-w-4xl">
            ...
            <header className="mb-12 animate-fade-in">
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-secondary mb-8 leading-relaxed font-medium">
                O câncer de canal anal é uma doença rara em comparação ao câncer
                colorretal, mas sua incidência tem aumentado, especialmente em
                grupos de risco. A prevenção e o rastreamento precoce são
                fundamentais para o diagnóstico inicial e melhores resultados no
                tratamento.
              </p>
            </header>
            ...
            <main className="prose prose-lg max-w-none mb-12">
              ...
              <ul>
                <li>
                  O uso do <strong>preservativo</strong> reduz o risco de
                  transmissão.
                </li>
                <li>
                  A <strong>vacinação contra o HPV</strong> é uma das medidas
                  mais eficazes e está disponível pelo SUS para adolescentes e
                  alguns grupos de risco.
                </li>
                <li>
                  O diagnóstico e tratamento precoce de lesões precursoras, como
                  a <strong>neoplasia intraepitelial anal (NIA)</strong>, podem
              ...
              <p>
                O rastreamento não é indicado para toda a população, mas sim
                para <strong>grupos de maior risco</strong>:
              </p>
              <ul>
                ...
                <li>
                  Pacientes com lesão de colo de útero ou que já tiveram
                  diagnóstico de câncer associado ao HPV.
                </li>
                <li>
                  Pessoas com imunossupressão prolongada (pós-transplante ou
                  doenças autoimunes em uso de imunossupressores).
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <strong>Exame proctológico</strong>: inclui inspeção anal e
                  toque retal, avaliando alterações locais.
                </li>
                <li>
                  <strong>Citologia anal</strong>: exame semelhante ao
                  Papanicolau, que detecta alterações celulares sugestivas de
                  lesões precursoras.
                </li>
                <li>
                  <strong>Anuscopia de Alta Resolução (AAR)</strong>: permite
                  visualizar a mucosa anal de forma detalhada e realizar
              ...
              <p>
                A prevenção continua sendo a forma mais eficaz de reduzir casos,
                especialmente com a <strong>vacinação contra o HPV</strong> e a
              ...
              <blockquote className="border-l-4 border-primary/30 pl-6 py-4 my-8 bg-primary/5 rounded-r-xl">
                <div className="space-y-4">
                  <p className="text-secondary italic mb-0">
                    ...
                    , demonstrou que tratar lesões precursoras em pacientes
            ...
            <CallToActionCard
              ...
              body={
                <p>
                  ...
                  da melhor estratégia de rastreamento. A detecção precoce pode
