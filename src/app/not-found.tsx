  ...
  return (
    ...
    >
      <div className="max-w-lg w-full text-center">
        ...
        <div className="mb-12">
          <h1 className="text-8xl sm:text-9xl font-serif font-bold text-primary mb-6 tracking-tight">
            404
          </h1>
        ...
        <div className="space-y-4 mb-12">
          <LinkButton
            ...
            variant="primary"
            size="xl"
            className="w-full bg-primary hover:bg-primary/90 text-background shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
          >
        ...
        {/* Contact section with footer-style design */}
        <div className="pt-8 border-t border-primary/10">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="font-medium">{WPP_NUMBER_NASSIF_FORMATTED}</span>
            </Link>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 text-secondary hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50 rounded-md px-2 py-1"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-medium">@analuiza.mrocha</span>
            </Link>
          </div>

          {/* Medical credentials - subtle */}
          <div className="mt-6 pt-4 border-t border-primary/10">
            <p className="text-xs text-secondary">CRM-PR 45351 | RQE 36221</p>
          </div>
        </div>
      </div>
    </main>
