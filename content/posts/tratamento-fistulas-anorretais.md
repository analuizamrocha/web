...
faqs:
  ...
  - question: 'Toda fístula precisa de cirurgia?'
    answer: 'A maioria exige abordagem cirúrgica ou procedimento específico. A técnica depende do tipo de fístula e do risco para continência.'
  - question: 'Para que serve o seton?'
    answer: 'O seton ajuda a drenar secreção e controlar a inflamação, especialmente em fístulas complexas, preparando o tratamento definitivo.'
  - question: 'Doença de Crohn muda o tratamento da fístula?'
    answer: 'Sim. Quando há associação com Crohn, o plano precisa ser individualizado e pode incluir terapia medicamentosa e abordagem combinada.'
---

_Cada fístula anorretal tem um trajeto próprio, e o melhor resultado depende de diagnóstico preciso e estratégia personalizada._

A fístula anorretal é uma condição que exige avaliação especializada e planejamento cuidadoso.
Quando mal conduzida, pode gerar recorrência, inflamações repetidas e, principalmente, risco à continência anal.
...
A fístula anal é um trajeto inflamatório que conecta o interior do canal anal à pele ao redor do ânus.
Na maioria das vezes, surge após um abscesso anal prévio.
...
Indicado principalmente em fístulas complexas ou com inflamação ativa.
Permite controle da infecção e preparo para abordagem definitiva, reduzindo risco de complicações.
